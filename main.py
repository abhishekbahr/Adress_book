...
def show():
    global tree
    listheader=['Name','Gender','Telephone','Email Id']
    demo_list= view()
    ...
    tree.heading(3,text='Email Id',anchor=NW)
    #tree columns
...
def to_update():
    try :
        ...
        def confirm():
            ...
            messagebox.showinfo('Success','Data added sucessfully.')
            ...
            show()
        b_confirm=Button(frame_down,text="Confirm",width=10,height=1,bg=co8,font=('Ivy 8 bold'),command=confirm)
...
l_email=Label(frame_down,text="Email Id *",width=20,height=1,font=('Ivy 10'),bg=co0,anchor=NW)
...
b_search=Button(frame_down,text="Search",height=1,bg=co2,font=('Ivy 8 bold'),command=to_search)
...
b_view=Button(frame_down,text="View",width=10,height=1,bg=co2,font=('Ivy 8 bold'),command=show)
b_view.place(x=290,y=50)

b_add=Button(frame_down,text="Add",width=10,height=1,bg=co2,font=('Ivy 8 bold'),command=insert)
b_add.place(x=400,y=50)

b_update=Button(frame_down,text="Update",width=10,height=1,bg=co2,font=('Ivy 8 bold'),command=to_update)
b_update.place(x=400,y=80)

b_delete=Button(frame_down,text="Delete",width=10,height=1,bg=co7,font=('Ivy 8 bold'),command=to_remove)
